#include "sdcard.h"
#include "sysctl.h"
#include "kendryte-standalone-sdk/lib/drivers/include/gpiohs.h"
#include "fpioa.h"
#include "dmac.h"
...
{
//    gpiohs_set_pin(32, GPIO_PV_HIGH);
...
{
//    gpiohs_set_drive_mode(32, GPIO_DM_OUTPUT);
...
uint8_t sd_init(void)
{
    ...
    if (index == 0)
    {
        Serial.printf("SD_CMD0 is %X\n", result);
        return 0xFF;
    }
	Serial.println("cmd8 execute.");
